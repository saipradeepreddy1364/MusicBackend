...
public class JioSaavnService {
    ...
    private static final Logger log = Logger.getLogger(JioSaavnService.class.getName());
    ...
    public Map<String, Object> searchSongs(String query) {
        try {
            ...
            log.severe("API error while searching songs: " + e.getResponseBodyAsString());
            throw new RuntimeException("Failed to fetch songs from JioSaavn API");
        } catch (Exception e) {
            log.severe("Unexpected error while searching songs: " + e.getMessage());
    ...
    public Map<String, Object> getSongDetails(String songId) {
        try {
            ...
            log.severe("API error while fetching song details: " + e.getResponseBodyAsString());
            throw new RuntimeException("Failed to fetch song details");
        } catch (Exception e) {
            log.severe("Unexpected error while fetching song details: " + e.getMessage());
            throw new RuntimeException("Unexpected error occurred");
        }
    }
    ...
    public Map<String, Object> getAlbumDetails(String albumId) {
        try {
            ...
            log.severe("API error while fetching album details: " + e.getResponseBodyAsString());
            throw new RuntimeException("Failed to fetch album details");
        } catch (Exception e) {
            log.severe("Unexpected error while fetching album details: " + e.getMessage());
            throw new RuntimeException("Unexpected error occurred");
        }
    }
    ...
    public Map<String, Object> getArtistDetails(String artistId) {
        try {
            ...
            log.severe("API error while fetching artist details: " + e.getResponseBodyAsString());
            throw new RuntimeException("Failed to fetch artist details");
        } catch (Exception e) {
            log.severe("Unexpected error while fetching artist details: " + e.getMessage());
            throw new RuntimeException("Unexpected error occurred");
        }
    }
    ...
    public Map<String, Object> getTrendingSongs() {
        try {
            ...
            log.severe("API error while fetching trending songs: " + e.getResponseBodyAsString());
            throw new RuntimeException("Failed to fetch trending songs");
        } catch (Exception e) {
            log.severe("Unexpected error while fetching trending songs: " + e.getMessage());
            throw new RuntimeException("Unexpected error occurred");
        }
    }
