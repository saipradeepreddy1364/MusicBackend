...
public class JioSaavnService {
    ...
    public Object search(String query, int page, int limit) {
        ...
        return get("/search", Map.of("q", query, "page", page, "limit", limit));
    }
    ...
    public Object searchSongs(String query, int page, int limit) {
        ...
        return get("/search/songs", Map.of("q", query, "page", page, "limit", limit));
    }
    ...
    public Object searchAlbums(String query, int page, int limit) {
        ...
        return get("/search/albums", Map.of("q", query, "page", page, "limit", limit));
    }
    ...
    public Object searchArtists(String query, int page, int limit) {
        ...
        return get("/search/artists", Map.of("q", query, "page", page, "limit", limit));
    }
    ...
    public Object searchPlaylists(String query, int page, int limit) {
        ...
        return get("/search/playlists", Map.of("q", query, "page", page, "limit", limit));
    }
    ...
    public Object getCharts() {
        ...
        // saavn.dev exposes trending playlists via this search
        ...
        try {
            return jiosaavnClient.get()
                    ...
                    .onErrorResume(WebClientResponseException.class, ex -> {
                        log.error("JioSaavn proxy error: {} {}", ex.getStatusCode(), ex.getMessage());
                        return Mono.error(new RuntimeException("JioSaavn API error: " + ex.getMessage()));
                    })
                    .block();
        } catch (Exception ex) {
            log.error("Failed to call JioSaavn proxy at {}: {}", path, ex.getMessage());
